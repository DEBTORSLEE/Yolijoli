                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success) {//로그인 성공시
                                ...
                                String UserBonth = jsonObject.getString( "UserBonth" );
                                ...
                                intent.putExtra( "UserBonth", UserBonth );
                                intent.putExtra( "UserGender", UserGender );
                                intent.putExtra( "UserPhone", UserPhone );

                                if(checkRememberId.isChecked()){
                                    editor.putString("rememberId",UserEmail);
                                    editor.putString("rememberName",UserName);
                                    editor.putString("rememberBonth",UserBonth);
                                    editor.putString("rememberGender",UserGender);
                                    editor.putString("rememberPhone",UserPhone);
                                    editor.commit();
                                }else{
